            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Affiliator</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <form action ="/Admin/product/{{$data_product->id}}/update" method = "POST" >
                           {{csrf_field()}}
                            
                           <div class="form-group">
                                <label for="exampleInputEmail1">Product ID</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Product ID" name="product_id" value="{{$data_product->product_id}}" disabled>
                                @error('product_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your Product name" name="product_name" value="{{$data_product->product_name}}">
                                @error('product_name')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Details" name="product_detail" value="{{$data_product->product_detail}}">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="file" class="form-control" id="file" aria-describedby="emailHelp" placeholder="" name="product_image" value="{{$data_product->product_image}}">
                                @error('product_image')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="product_price" value="{{$data_product->product_price}}">
                                @error('product_price')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Category" name="product_category" value="{{$data_product->product_category}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="SKU" name="sku" value="{{$data_product->sku}}">
                                @error('sku')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="kg" name="weight" value="{{$data_product->weight}}">
                                @error('weight')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Stock" name="inventory" value="{{$data_product->inventory}}">
                                @error('inventory')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Price Stokist</label>
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="RM" name="price_stokist" value="{{$data_product->price_stokist}}">
                                @error('price_stokist')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Minimum of Quantity to Buy by Stokist</label>
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Unit" name="moq_stokist" value="{{$data_product->moq_stokist}}">
                                @error('moq_stokist')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Price Agent</label>
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="RM" name="price_agent" value="{{$data_product->price_agent}}">
                                @error('price_agent')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Maximum of Quantity to Buy by Agent</label>
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Unit" name="moq_agent" value="{{$data_product->moq_agent}}">
                                @error('moq_agent')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1">Comission Affiliator</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="commission_affiliate" value="{{$data_product->commission_affiliate}}">
                                @error('commission_affiliate')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Comission Dropshiper</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="commission_dropship" value="{{$data_product->commission_dropship}}">
                                @error('commission_dropship')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
