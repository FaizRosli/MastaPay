            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <h4 class="card-title">List Of Dropshipper</h4>
                                            This is your Dropshipper registration link la weiiii!!  <a href="{!!$page_url!!}">{{$page_url}}</a>
                            <div class="text-right">
                                            <a type="button" class="btn waves-effect waves-light btn-success" href="/Admin/product/Add">Add New</a></div><br>
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                            ...
                                            <td><img src = "{{$product->getproduct_image()}}" width="150" height="90" class="rounded-circle"/></td>
                                            ...
                                            <td>{{$product->price_stokist}}</td>
                                            <td>{{$product->moq_stokist}}</td>
                                            <!-- <td>{{$product->price_agent}}</td> -->
                                            <td>{{$product->commission_dropship}}</td>
                                            <td>{{$product->product_link}}</td>
                                            <td> <a href="/Admin/product/{{$product->id}}/Edit" class="icon-Pencil text-dark"></a><a href="/Admin/product/{{$product->id}}/Delete" class="ti-trash text-dark"></a>  </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <h5><i class="ti-mobile"></i> 011-562770088 (Whatsapp Support)</h5>
                                <small>Please contact with us if you have any questions. We'll reply as soon as possible.</small>
                            </div>
                        </div>
                </div>
            </div>
