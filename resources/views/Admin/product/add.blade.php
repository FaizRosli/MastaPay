        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h5 class="m-b-0 text-white">Add Product</h5>
                                </div>
                            <div class="card-body">
                           ...
                           {{csrf_field()}}
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Product ID" name="product_id">
                                <small id="emailHelp" class="form-text text-muted">Must be unique combination of alphabet and numbers. For example : abc123</small>
                                @error('product_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your Product name" name="product_name">
                                @error('product_name')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Details" name="product_detail">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="file" class="form-control" id="file" aria-describedby="emailHelp" placeholder="" name="product_image">
                                @error('product_image')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="product_price">
                                @error('product_price')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Category" name="product_category">
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="SKU" name="sku">
                                @error('sku')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="kg" name="weight">
                                @error('weight')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Stock" name="inventory">
                                @error('inventory')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="RM" name="price_stokist">
                                @error('price_stokist')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Unit" name="moq_stokist">
                                @error('moq_stokist')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="RM" name="price_agent">
                                @error('price_agent')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="Unit" name="moq_agent">
                                @error('moq_agent')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="commission_affiliate">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="RM" name="commission_dropship">
