                        ...
                        <div class="page-breadcrumb">
                            <div class="row">
                                <div class="col-5 align-self-center">
                                    <h4 class="page-title">Dropship</h4>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <!-- <h4 class="card-title">{!!$register_url!!}</h4> -->
                                            <h4 class="card-title">List Of Dropshipper</h4>
                                            This is your Dropshipper registration link la weiiii!!  <a href="{!!$register_url!!}">{{$register_url}}</a>
                                            <div class="text-right">
                                            <a type="button" class="btn waves-effect waves-light btn-success" href="/Admin/Dropship/Add">Add New</a></div>
                                                ...
                                                <table id="zero_config" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>{{$dropship->full_name}}</td>
                                                                <td>{{$dropship->phone}}</td>
                                                                <td>{{$dropship->gender}}</td>
                                                                <td>{{$dropship->bank_name}}</td>
                                                                <td>{{$dropship->bank_acc_holder}}</td>
                                                                <td>{{$dropship->bank_acc_number}}</td>
                                                                <td> <a href="/Admin/Dropship/{{$dropship->id}}/Edit">update</a> <a href="/Admin/Dropship/{{$dropship->id}}/Delete">delete</a>  </td>
                                                        </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
