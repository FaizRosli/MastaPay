            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Dropshipper</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <form action ="/Admin/Dropship/{{$data_dropship->id}}/Update" method = "POST" >
                           {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email" value="{{$data_dropship->email}}" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your full name" name="full_name" value="{{$data_dropship->full_name}}">
                                @error('full_name')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" name="password" value="{{$data_dropship->password}}" disabled>
                                @error('password')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your phone number" name="phone" value="{{$data_dropship->phone}}">
                                @error('phone')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1"name="gender" value="{{$data_dropship->gender}}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect1"name="bank_name" value="{{$data_dropship->bank_name}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your bank account number" name="bank_acc_number" value="{{$data_dropship->bank_acc_number}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter bank account holder" name="bank_acc_holder" value="{{$data_dropship->bank_acc_holder}}">
