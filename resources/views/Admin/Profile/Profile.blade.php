            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center> <img src="../../assets/images/users/5.jpg" class="rounded-circle"/>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" method ="post" action="/Profile/{{$data_profile->id}}/edit" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" name="name" value="{{$data_profile->name}}" required>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-12">Designation</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" name="designation" value="{{$data_profile->designation}}" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Email</label>
                                                <div class="col-md-12">
                                                    <input type="email" placeholder="" class="form-control form-control-line" name="email" value="{{$data_profile->email}}"required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Mobile Number</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" name="phone" value ="{{$data_profile->phone}}" required>
                                                </div>
                                            </div>										
                                            <div class="form-group">
                                    ...
                                    <form class="form-horizontal form-material" action="" method="post">
                                           {{csrf_field()}}
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="Please insert company name" class="form-control form-control-line" name="name" value="" required>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-12">Industry Type</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" name="industry" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Registration Number (ROC)</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" id="example-email" name="registration_number" value="" required>
                                                </div>                                            
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Address</label>
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="" class="form-control form-control-line" id="example-email" name="address" value ="" required>
                                                </div>                                            
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" placeholder="" class="form-control form-control-line" id="example-email" name="google_map" value= "">
