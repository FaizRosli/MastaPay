            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add Affiliator</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <form action ="/Admin/Affiliate/Create" method = "POST" >
                           {{csrf_field()}}
                            <div class="form-group">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter bank account holder" name="affiliate_url" value="https://xxxx">
                                    @error('affiliate_url')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div> -->
