                        ...
                        <div class="page-breadcrumb">
                            <div class="row">
                                <div class="col-5 align-self-center">
                                    <h4 class="page-title">List Affiliator</h4>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title">List Affiliator</h4>
                                            <div class="text-right">
                                            <a type="button" class="btn waves-effect waves-light btn-success" href="/Admin/Affiliate/Add">Add New</a></div>
                                            <div class="text-left">
                                            <div class="table-responsive">
                                                <table id="zero_config" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $count=1;
                                                         @endphp
                                                         @foreach ($data_affiliate as $affiliate)
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>{{$affiliate->bank_acc_holder}}</td>
                                                                <td>{{$affiliate->bank_acc_number}}</td>
                                                                <td><a href="{{$affiliate->affiliate_url}}">{{$affiliate->affiliate_url}}</a></td>
                                                                <td> <a href="/Admin/Affiliate/{{$affiliate->id}}/Edit">update</a> <a href="/Admin/Affiliate/{{$affiliate->id}}/Delete">delete</a>  </td>
                                                        </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
