                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <span class="hide-menu">Pages Product </span>
                            </a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a href="manage-page.html" class="sidebar-link">
                                        <i class="mdi mdi-book-multiple"></i>
                                        <span class="hide-menu"> Manage Page </span>
                                    </a>
                            </ul>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Bisnes owner</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <form action ="/System/{{$data_user->id}}/Update" method = "POST" >
                           {{csrf_field()}}
                           <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="id" value="{{$data_user->id}}">
                                
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email" value="{{$data_user->email}}">
                                <small id="emailHelp" class="form-text text-muted">jangan tukar emel bisnes owner woi.</small>
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your full name" name="name" value="{{$data_user->name}}">
                                @error('name')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="package_type" value="{{$data_user->package_type}}" id="package_type" >
                                <option id ="basic" value ="Basic">Basic (free)</option>
                                <option id ="startup"value ="Startup">Startup</option>
                                <option id ="pro"value ="Pro">Pro</option>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlSelect1" > Period subscription</label>
                                <select class="form-control" id="period_subs"name="period_subscription" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="renew_date" aria-describedby="emailHelp" placeholder="Enter bank account holder" name="renew_date" value="{{$data_user->renew_date}}">
