...
namespace MastaPay\Notifications;
...
class DropshipResetPasswordNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->action('Reset password', url('/Dropship/password/reset/'.$this->token))
